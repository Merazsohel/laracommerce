                ...
                <div class="col-md-9 col-sm-8 float-none float-right padding-left-5">
                    <div class="main-content">
                        <div class="toolbar-products">
                            <h4 class="title-product">Available {{$childcaegory->childcategory}}S </h4>
                        </div>
                                            ...
                                            <div class="product-item style1">
                                                <div class="product-inner equal-elem">
                                                    ...
                                                    <div class="product-innfo">
                                                            <div class="product-name"><a href="{{route('productdetails',[$product->title,'id'=>$product->id])}}">{{$product->title}}</a></div>
                                                            <span class="price">
                                    ...
                                    <div class="filter-options-content">
                                        <ul>
                                           @foreach($subcategories as $subcategory)
                                                <li><label class="inline" ><input type="checkbox" class="subcategory"  value="{{$subcategory->subcategory}}"><span class="input"></span>{{$subcategory->subcategory}}</label></li>
                                           @endforeach
                                               <form id="subcategoryform" name="subcategoryform" method="get">
...
@section('script')
    <script>
        ...
        $('.subcategory').on('click',function () {
            ...
            $("#subcategoryform").attr('action',  document.location.origin+'/options/'+$(this).val()+'');
            var x = document.getElementsByName('subcategoryform');
            x[0].submit();
        })
    </script>
@endsection

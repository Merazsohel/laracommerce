                                ...
                                @foreach($cartContents as $cartContent)
                                    ...
                                    <tr>
                                        <td class="plantmore-product-thumbnail"><a
                                                    href="{{route('productdetails',['title'=>$cartContent->name,'id'=>$cartContent->id])}}">
                                        ...
                                        <td class="plantmore-product-quantity">
                                            ...
                                            <form action="{{ route('cart.update') }}" method="post" >
                                                @csrf
                                            <input type="number" name="qty" value="{{$cartContent->qty}}" style="width:45px;text-align: center">
                                        ...
                                        <td class="plantmore-product-remove">
                                            <a href="{{ route('cart.remove', $cartContent->rowId) }}"><i

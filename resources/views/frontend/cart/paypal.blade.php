...
<form style=" padding:0px;margin:0px;" name="frmOrderAutoSubmit" method="post" >
    ...
    <input type="hidden" name="quantity" value="{{\Gloudemans\Shoppingcart\Facades\Cart::content('qty')}}">
    <input type="hidden" name="item_name" value="{{\Gloudemans\Shoppingcart\Facades\Cart::content('name')}}">
    <input type="hidden" name="amount" value="{{ \Gloudemans\Shoppingcart\Facades\Cart::content('total')}}">


    <input type="hidden" name="rm" value="2" />
    <input TYPE="hidden" name="address_override" value="0">
    <input type="hidden" name="first_name" value="{{\Illuminate\Support\Facades\Session::get('customer_name')}}">

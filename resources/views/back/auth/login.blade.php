...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('public/back/plugins/iCheck/square/blue.css') }}">
  ...
  <div class="login-box-body">
    ...
    <form action="{{route('login')}}" method="post">
      ...
      <div class="form-group has-feedpublic/back">
        ...
        <span class="glyphicon glyphicon-envelope form-control-feedpublic/back"></span>
      </div>
      <div class="form-group has-feedpublic/back">
        <input type="password" class="form-control" name="password" placeholder="Password">
        <span class="glyphicon glyphicon-lock form-control-feedpublic/back"></span>
      </div>
      <div class="row">
        <div class="col-xs-8">

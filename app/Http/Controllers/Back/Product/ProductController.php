...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       if( $request->color!='' && sizeof($request->color)>=1)
       {
        ...
        {
            $destinationPath="image/product-images";
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('images'))
        {
            ...
            {
                if(file_exists('image/product-images/'.$existingImage[$x]['image']))
                {
                    unlink('image/product-images/'.$existingImage[$x]['image']);
                }
            }
        }
    ...
    public function destroy(Request $request,$id)
    {
        ...
        {
            if(file_exists('image/product-images/'.$product->image[$i]->image))
            {
                unlink('image/product-images/'.$product->image[$i]->image);
            }
        }
        $product->delete();
